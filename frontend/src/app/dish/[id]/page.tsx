...
import { ActionButton, SurfaceCard, CardContent, BusyIndicator } from '@/components/primitives/primitiveExports'
import { PantryItemList, PrepStepGuide } from '@/components/dish-gallery/galleryExports'
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          <BusyIndicator size="lg" className="mb-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <ActionButton variant="ghost" size="sm" onClick={handleShare}>
