...
import { ChatMessage as DialogueMessageType } from '@/types'
import { ActionButton } from '@/components/primitives/primitiveExports'

interface DialogueBubbleProps {
  message: DialogueMessageType
            ...
            <div className="space-y-2">
              {message.metadata.recipes.slice(0, 3).map((recipe: any, index: number) => (
                <div key={index} className="flex items-center justify-between">
                  ...
                  <ActionButton variant="ghost" size="sm" className="text-blue-600">
                    查看详情
                  </ActionButton>
                </div>
              ))}
